...
Loader.prototype = {
	...
	loadBinary: function( url, callback, urlbase ) {
		...
		worker.onmessage = function( event ) {
			...
			Loader.prototype.loadAjaxBuffers( buffers, materials, callback, urlbase );
	...
	createBinModel: function ( data, callback, urlbase, materials ) {
		...
		var Model = function ( urlbase ) {
			...
			function add_uv3( i ) {
				...
				Loader.prototype.uv( scope, u1, v1, u2, v2, u3, v3 );
			...
			function add_uv4( i ) {
				...
				Loader.prototype.uv( scope, u1, v1, u2, v2, u3, v3, u4, v4 );
